...
public class WordCounter {
    public static Map<String, Integer> calculateWord(String text) {
        // Kelimeleri saklamak için bir HashMap oluşturuyoruz
        Map<String, Integer> wordCountMap = new HashMap<>();

        // Metni küçük harfe çevir ve özel karakterlerden temizle
        String cleanedText = text.toLowerCase().replaceAll("[^a-zA-Z\\s]", "");

        // Metni boşluklara göre bölerek kelime dizisi oluştur
        String[] words = cleanedText.split("\\s+");

        // Her kelimeyi dolaş ve sayısını artır
    ...
    public static void main(String[] args) {
        ...
        Map<String, Integer> wordCountMap = calculateWord(text);

        // Kelimelerin sayısını yazdır
